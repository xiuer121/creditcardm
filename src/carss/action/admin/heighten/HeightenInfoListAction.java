...
@Controller
@Scope("prototype")
@Results({ @Result(location = "heighten-info-list.jsp") })
public class HeightenInfoListAction extends ActionSupport {
	...
	public String execute() {
		...
		String where = " where  1 = 1 and cardType = 30  and cardStates = 10 ";
