...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="scrollContent">
			<div class="box2" panelTitle="刷卡操作" roller="true">



				<s:form id="commitForm" action="repayment-update" method="post">
					<s:hidden name="id" />
					<table class="tableStyle" transMode="true">
						...
						<tr>
							...
							<td>
								<s:textfield id="personName" name="personName" disabled="true"/>
							</td>
						</tr> 
						<tr>
							<td>
							...
							<td>
								<s:textfield id="cardNo" name="cardNo" disabled="true" />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<s:textfield id="credits" name="credits" disabled="true" />
							</td>
						</tr>
