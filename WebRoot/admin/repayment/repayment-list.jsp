...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function openWin(id) {
		...
		diag.Title = "刷卡操作";
		diag.URL = "repayment/repayment-update!show.action?id=" + id;
		diag.Height = 480;
		diag.Width = 680;
		diag.MessageTitle = "刷卡操作";
		diag.Message = "刷卡操作";
								...
								<table>
									<tr>
										...
										<td>
											...
											<s:select list="#{'5':'请选择','10':'今日需还','20':'5日内需还'}"
												name="repayDays" headerKey="5" headerValue="请选择" />
										</td>
					...
					<table class="tableStyle">
						...
						<c:forEach items="${view.records}" var="o">
							<tr>
								...
								<td>
									<fmt:formatDate value="${o.repaymentDate}" pattern="yyyy-MM-dd" />
								</td>
								<td> 
								...
								<td>
									<a href="javascript:openWin(${o.id})"> <span
										class="icon_edit">刷卡</span> </a>
									<a class="myCancel" id="${o.id}"> <span class="icon_delete">取消</span>
									</a>
									<!--
									<a href="../heighten/heighten-info-add!zhuan.action?id=${o.id}">
										<span class="icon_mark">提额</span> </a>  -->
								</td>
							</tr>
						</c:forEach>
					</table>
