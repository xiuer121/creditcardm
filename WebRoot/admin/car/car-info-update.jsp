...
<s:form id="commitForm" action="car-update" method="post" enctype="multipart/form-data">
						...
						<table class="tableStyle" formMode="true">
							...
							<tr>
								...
								<td width="10%">车辆类型：</td>
								<td width="40%">
									<s:select list="#{10:'跑车',20:'轿车',30:'SUV',40:'商务车'}" name="carType"  listKey="key" listValue="value" />
								</td>
							</tr> 
							<tr> 
								<td>推荐车型：</td>
